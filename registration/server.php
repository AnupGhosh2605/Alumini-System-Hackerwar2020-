...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($regno)) { array_push($errors, "year is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO user (username, email,phone,regno,year,branch, password) 
  			  VALUES('$username', '$email','$phone','$regno','$regno','$branch', '$password')";
